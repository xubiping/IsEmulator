...
import static com.android.app.unittesting.staticf.CheckResult.RESULT_EMULATOR;
import static com.android.app.unittesting.staticf.CheckResult.RESULT_MAYBE_EMULATOR;
import static com.android.app.unittesting.staticf.CheckResult.RESULT_UNKNOWN;
...
public class EmulatorCheckUtil {
    ...
    public boolean readSysProperty(Context context, EmulatorCheckCallback callback) {
        ...
        if (sensorNumber <= 20) ++suspectCount;
        ...
        if (callback != null) {
            StringBuffer stringBuffer = new StringBuffer("Test start")
                    ...
                    .append("\r\n").append("pluggedudb = ").append(Utils.checkPluggedudb(context));
